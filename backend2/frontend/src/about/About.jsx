...
function About() {
  return (
    <>
      <div className="flex flex-col sm:flex-row bg-DarkGray h-screen absolute">
        <Logout />
          ...
          <div className="p-5">
            ...
            <div className="border border-violet-400 p-4">
              <p className="text-lg text-violet-400 font-Sansation">
                ...
                designed for seamless communication. Built with the MERN
                (MongoDB, Express, React, Node.js) stack and powered by
                Socket.IO for live interactions, ChatSphere allows users to:
                <div className="">
                  <ul className="list-disc list-inside">
                    ...
                    <li className="py-2">
                      Emoji board for expressive chatting
                    </li>
                    <li className="py-2">
            ...
            <div className="border border-violet-400 p-4 flex flex-col sm:flex-row gap-5">
              <div className="avatar">
                <div className="w-24 rounded-full">
                  <img src="/ME (2).jpg" alt="Developer" />
                </div>
              </div>
              <p className="text-lg text-violet-400 font-Sansation">
                ...
                backend logic. Hope you enjoy using it as much as I enjoyed
                making it!
              </p>
            </div>

            <h1 className="text-violet-400 text-right m-5">
              Thanks and regards
            </h1>
          </div>

          <footer className=" bg-base-300 p-4">
            <p className="text-center text-sm sm:text-base px-4 max-w-2xl">
              Your honest{" "}
              <a
              ...
              will be very helpful in making the user experience better.
            </p>
          </footer>
        </div>
      </div>
